...
// configuration step. It creates a namespace called `StereoCam`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", StereoCam::cmake::project_name, StereoCam::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", StereoCam::cmake::project_version);
      return EXIT_SUCCESS;
    }
